...
function Second() {
  ...
  useEffect(() => {
    const updateTimer = () => {
      ...
      if (now > birthday) birthday.setFullYear(currentYear + 1);
          ...
          <div className="bg-white text-pink-700 rounded-2xl p-8 shadow-2xl flex flex-col items-center">
            ...
            <form onSubmit={sendEmail} className="mt-5 flex flex-col gap-3 items-center w-full">
              ...
              <button
                type="submit"
                disabled={isSending}
                className="bg-pink-500 cursor-pointer text-white px-5 py-2 rounded-lg hover:bg-pink-600 transition-all"
              >
